...
public class JidiqiyeCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public JidiqiyeCollectionEntity() {

	}

	public JidiqiyeCollectionEntity(T t) {
		try {
