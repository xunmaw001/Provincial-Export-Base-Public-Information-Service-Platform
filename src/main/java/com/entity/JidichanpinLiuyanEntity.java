...
public class JidichanpinLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public JidichanpinLiuyanEntity() {

	}

	public JidichanpinLiuyanEntity(T t) {
		try {
    ...
    public String toString() {
        return "JidichanpinLiuyan{" +
            "id=" + id +
            ", jidichanpinId=" + jidichanpinId +
            ", yonghuId=" + yonghuId +
            ", jidichanpinLiuyanContent=" + jidichanpinLiuyanContent +
