...
public class JidiqiyeLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public JidiqiyeLiuyanEntity() {

	}

	public JidiqiyeLiuyanEntity(T t) {
		try {
    ...
    public String toString() {
        return "JidiqiyeLiuyan{" +
            "id=" + id +
            ", jidiqiyeId=" + jidiqiyeId +
            ", yonghuId=" + yonghuId +
            ", jidiqiyeLiuyanContent=" + jidiqiyeLiuyanContent +
