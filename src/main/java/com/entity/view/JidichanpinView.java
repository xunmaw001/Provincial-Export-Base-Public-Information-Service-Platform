...
public class JidichanpinView extends JidichanpinEntity implements Serializable {
	...
	public JidichanpinView() {

	}

	public JidichanpinView(JidichanpinEntity jidichanpinEntity) {
		try {
			BeanUtils.copyProperties(this, jidichanpinEntity);
