 ...
 * @date 2021-04-19
 */
@TableName("jidichanpin_collection")
public class JidichanpinCollectionView extends JidichanpinCollectionEntity implements Serializable {
	...
	public JidichanpinCollectionView() {

	}

	public JidichanpinCollectionView(JidichanpinCollectionEntity jidichanpinCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, jidichanpinCollectionEntity);
