...
public class JidiqiyeLiuyanView extends JidiqiyeLiuyanEntity implements Serializable {
	...
	public JidiqiyeLiuyanView() {

	}

	public JidiqiyeLiuyanView(JidiqiyeLiuyanEntity jidiqiyeLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, jidiqiyeLiuyanEntity);
