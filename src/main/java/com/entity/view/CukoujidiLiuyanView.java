...
public class CukoujidiLiuyanView extends CukoujidiLiuyanEntity implements Serializable {
	...
	public CukoujidiLiuyanView() {

	}

	public CukoujidiLiuyanView(CukoujidiLiuyanEntity cukoujidiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, cukoujidiLiuyanEntity);
