                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6" id="shengji">
                                        <label>升级为会员</label>
                                        <div class="layui-form-mid layui-word-aux">
                                            <a id="btn-recharge" data-target="#exampleModal" href="javascript:void(0)" data-toggle="modal">点我升级为会员</a>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>身份</label>
                                        <input id="role" readonly name="role" value="用户" class="form-control"
                                               placeholder="身份">
                                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="pay-type-list">
                        ...
                        <div class="pay-type-item" style="margin-top: 10px">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="receive" class="btn btn-primary" onclick="huiyuan()">支付</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function huiyuan() {
        httpJson("yonghu/huiyuan", "POST", ruleForm, (res) => {
            alert("升级成功");
