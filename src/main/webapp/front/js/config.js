...
var projectName = 'N 省出口基地公共信息服务平台';
/**
 * 轮播图配置
 */
var swiper = {
...
var centerMenu = [
    ...
    ,{
        name: '出口基地收藏',
        url: '../cukoujidiCollection/list.jsp'
    }
    ,{
        name: '基地产品收藏',
        url: '../jidichanpinCollection/list.jsp'
    }
    ,{
        name: '基地企业收藏',
        url: '../jidiqiyeCollection/list.jsp'
    }
...
var indexNav = [
    ...
    {
        name: '出口基地',
        url: './pages/cukoujidi/list.jsp'
    },
    {
        name: '基地产品',
        url: './pages/jidichanpin/list.jsp'
    },
    {
        name: '基地企业',
        url: './pages/jidiqiye/list.jsp'
    },
    {
        name: '政策法规',
        url: './pages/zhengchefagui/list.jsp'
    },
    {
        name: '资讯动态',
        url: './pages/zhixundongtai/list.jsp'
    },
    {
        name: '会员专区',
...
var adminurl =  "http://localhost:8080/nshengchukoujidi/index.jsp";
