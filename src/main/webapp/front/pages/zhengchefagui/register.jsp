                ...
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="zhengchefaguiName" id="zhengchefaguiName"  placeholder="政策法规名称"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <select name="zhengchefaguiTypes" id="zhengchefaguiTypes" lay-filter="zhengchefaguiTypes" style="width: 600px;">
