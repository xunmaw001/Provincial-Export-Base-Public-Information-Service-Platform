                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../jidiqiye/detail.jsp?id='+item.id)">
                                ...
                                <div class="ng-prslist-tit" @click="jump('../jidiqiye/detail.jsp?id='+item.id)"><span>{{item.jidiqiyeName}}</span></div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 jidiqiyeContent 字段去除无用字符 如果字段长度大于60  就截取到60
            jidiqiyeContent: function(val) {
                if (val) {
        ...
        function pageList() {
            ...
            if (jidiqiyeTypes != null && jidiqiyeTypes != "" && jidiqiyeTypes != "null") {
                param['jidiqiyeTypes'] = jidiqiyeTypes;
                        ...
                        // 获取列表数据
            http.request('jidiqiye/list', 'get', param, function(res) {
