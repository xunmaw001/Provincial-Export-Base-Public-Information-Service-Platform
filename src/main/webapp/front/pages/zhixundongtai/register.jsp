              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">资讯动态名称:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="zhixundongtaiName" id="zhixundongtaiName"  placeholder="资讯动态名称"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">资讯动态类型:</span>
                        <div class="layui-input-inline">
                            <select name="zhixundongtaiTypes" id="zhixundongtaiTypes" lay-filter="zhixundongtaiTypes" style="width: 600px;">
