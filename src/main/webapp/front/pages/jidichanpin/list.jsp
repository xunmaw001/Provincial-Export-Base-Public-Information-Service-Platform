                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../jidichanpin/detail.jsp?id='+item.id)">
                                ...
                                <div class="ng-prslist-tit" @click="jump('../jidichanpin/detail.jsp?id='+item.id)"><span>{{item.jidichanpinName}}</span></div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 jidichanpinContent 字段去除无用字符 如果字段长度大于60  就截取到60
            jidichanpinContent: function(val) {
                if (val) {
        ...
        function pageList() {
            ...
            if (jidichanpinTypes != null && jidichanpinTypes != "" && jidichanpinTypes != "null") {
                param['jidichanpinTypes'] = jidichanpinTypes;
                        ...
                        // 获取列表数据
            http.request('jidichanpin/list', 'get', param, function(res) {
